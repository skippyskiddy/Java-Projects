...
/**
 * This interface outlines required methods for a PQ to implement:
 * checking if the PQ is empty, adding to the PQ, peeking at values,
 * and popping values out of the PQ.
 */
public interface PriorityQueue {
   ...
   * gets the value  of the earliest
   * added element.
